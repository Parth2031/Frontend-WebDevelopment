...
^ Terminal Commands for executing Typescript ->>
...
^ ALTERTERNATIVE -->>  tsc outFile app.js ( AFTER GETTING IMPORTS ) 
*/
...
^ Tuples (Type of Array) Data Type :->
...
^ Understanding Getters & Setters Properies :->
...
^ Understanding ReadOnly Property :-> 
...
^ Terminal Command to install Typescript Definition fror Libraries :->
